...
void Setup::_updateMotorConfigs()
{
    ...
    _motorConfigs.push_back(new MotorConfig {STP1, DIR1, &_motorJ1, _HOME_POS_J1, _minAngleDegJ1, _maxAngleDegJ1, 200, 64, 16.0f, 100.0f, 1.0f});
    _motorConfigs.push_back(new MotorConfig {STP2, DIR2, &_motorJ2, _HOME_POS_J2, _minAngleDegJ2, _maxAngleDegJ2, 200, 64, 16.0f, 80.0f, 14.0f});
    _motorConfigs.push_back(new MotorConfig {STP3, DIR3, &_motorJ3, _HOME_POS_J3, _minAngleDegJ3, _maxAngleDegJ3, 200, 64, 16.0f, 100.0f, 1.0f});
    _motorConfigs.push_back(new MotorConfig {STP4, DIR4, &_motorJ4, _HOME_POS_J4, _minAngleDegJ4, _maxAngleDegJ4, 200, 64, 16.0f, 60.0f, 1.0f});
    _motorConfigs.push_back(new MotorConfig {STP5, DIR5, &_motorJ5, _HOME_POS_J5, _minAngleDegJ5, _maxAngleDegJ5, 400, 64, 16.0f, 32.0f, 1.0f});
    _motorConfigs.push_back(new MotorConfig {STP6, DIR6, &_motorJ6, _HOME_POS_J6, _minAngleDegJ6, _maxAngleDegJ6, 200, 64, 1.0f, 1.0f, 1.0f});
}
