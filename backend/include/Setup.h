...
private:
    ...
    const float _minAngleDegJ1 = -180.0f;
    const float _maxAngleDegJ1 = 152.0f;

    const float _minAngleDegJ2 = -14.0f;
    const float _maxAngleDegJ2 = 88.0f;

    const float _minAngleDegJ3 = -57.0f;
    const float _maxAngleDegJ3 = 50.0f;

    const float _minAngleDegJ4 = -166.0f;
    const float _maxAngleDegJ4 = 180.0f;

    const float _minAngleDegJ5 = -120.0f;
    const float _maxAngleDegJ5 = 110.0f;

    const float _minAngleDegJ6 = -174.0f;
    const float _maxAngleDegJ6 = 180.0f;
